...
# TIME TABLE HERE
subjects = {'monday' : ['DCN', 'PHP', 'PHP-LAB'],
                'tuesday' : ['MP', 'PHP', 'DCN'],
                'wednesday' : ['PHP LAB','SE' , 'PHP'],
                'thursday' : [ 'MP' , 'PHP LAB','PHP'],
                'friday' :['SE','DCN','SE'],
                'saturday':['PHP','SE','DCN','TEST'],
              }

# GOOGLE MEET LINKS TO RESPECTIVE SUBJECTS
classes = { 'PHP':	'https://meet.google.com/avy-sfnq-hko',
                'DCN':'https://meet.google.com/gqz-gzan-zej',
                'SE':'https://meet.google.com/bva-gynp-nnb'     
          }
...
def find_classes():
    ...
    if    day != 'sunday':
        ...
        timings = ['8:30 am-9:30 am','9:30 am - 10:30 am', '10:30 am - 11:30 am']
...
def open_link(url):
    try:
        ...
        username.click()
        username.send_keys('mayhem7999@gmail.com')
        ...
        password.click()
        password.send_keys('NITHISATHI0708')
            ...
            try:
                ...
                for word in alertWords:
                    if word in captioTextLower:
                        ...
                        pag.write("Yes MAM ! I'm Present ! Mic issue 😥", interval=0.1)
                        time.sleep(0.5)
                        pag.press('enter')
                        time.sleep(2)
                time.sleep(0.5)
